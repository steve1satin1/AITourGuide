    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        for token in inference:
            chunk = GenerationChunk(text=token.generations[0]._text)

            if run_manager:
                run_manager.on_llm_new_token(token=chunk._text)
            yield chunk
    ...
    async def _astream(
        ...
        **kwargs: Any,
        ...
        for token in inference:
            ...
            if run_manager:
                await run_manager.on_llm_new_token(token=chunk._text)
            yield chunk
