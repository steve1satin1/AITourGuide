...
class DocArrayIndex(VectorStore, ABC):
    ...
    def similarity_search_with_score(
        ...
        result = [
            (Document(page_content=doc._text, metadata=doc.metadata), score)
    ...
    def similarity_search_by_vector(
        ...
        result = [
            Document(page_content=doc._text, metadata=doc.metadata) for doc in docs
        ]
        return result
    ...
    def max_marginal_relevance_search(
        ...
        **kwargs: Any,
        ...
        results = [
            Document(page_content=docs[idx]._text, metadata=docs[idx].metadata)
