        ...
        **kwargs: Any,
        ...
        for chunk in LLMInputOutputAdapter.prepare_output_stream(
            ...
            if run_manager is not None:
                run_manager.on_llm_new_token(chunk._text, chunk=chunk)
            yield chunk
        ...
        **kwargs: Any,
        ...
        async for chunk in LLMInputOutputAdapter.aprepare_output_stream(
            ...
            if run_manager is not None and asyncio.iscoroutinefunction(
                ...
                await run_manager.on_llm_new_token(chunk._text, chunk=chunk)
            elif run_manager is not None:
                run_manager.on_llm_new_token(chunk._text, chunk=chunk)  # type: ignore[unused-coroutine]
            yield chunk
