...
class ChatVertexAI(_VertexAICommon, BaseChatModel):  # type: ignore[override]
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        generations = [
            ChatGeneration(message=AIMessage(content=r._text))
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        for response in responses:
            chunk = ChatGenerationChunk(message=AIMessageChunk(content=response._text))
            if run_manager:
                run_manager.on_llm_new_token(response._text, chunk=chunk)
            yield chunk
