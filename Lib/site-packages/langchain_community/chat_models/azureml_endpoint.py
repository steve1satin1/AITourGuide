    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        for chunk in client.chat.completions.create(messages=message_dicts, **params):  # type: ignore[arg-type]
            ...
            if run_manager:
                run_manager.on_llm_new_token(chunk._text, chunk=chunk, logprobs=logprobs)  # type: ignore[attr-defined, arg-type]
            ...
            **params,  # type: ignore[arg-type]
            ...
            if run_manager:
                await run_manager.on_llm_new_token(
                    token=chunk._text, chunk=chunk, logprobs=logprobs
                )
            yield chunk
